  ...
  try {
      ...
      return jsonResponse(
        {
          ok: false,
          message:
            "You cannot revoke an invitation with a higher role.",
        },
        403,
      );
    }
      ...
      return jsonResponse(
        {
          ok: false,
          message:
            "This invitation was already accepted. Remove the workspace member instead.",
        },
        409,
      );
    }
    ...
    if (invitation.status === "revoked") {
      return jsonResponse(
        {
          ok: true,
          message: "The invitation is already revoked.",
        },
        200,
      );
    }
    ...
    await prisma.$transaction(async (transaction) => {
      ...
      await transaction.auditLog.create({
        data: {
          ...
          metadata: {
            note: `The invitation for ${invitation.email} was revoked.`,
    ...
    console.error(
      "[team-invitation-revoke] Invitation revocation failed:",
