      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-200 bg-white py-2.5 pl-10 pr-11 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 disabled:cursor-not-allowed disabled:bg-slate-50"
        ...
        >
          ...
          {emailNotVerified && email.trim() ? (
            <Link
              ...
              className="inline-block font-semibold text-indigo-700 underline underline-offset-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
