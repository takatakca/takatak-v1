    ...
    <section className="relative overflow-hidden bg-secondary/35 py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-4">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,0.82fr)_auto] lg:items-end">
          <div>
            ...
            <h2 className="mt-3 max-w-3xl text-3xl font-bold leading-tight text-foreground md:text-5xl">
              ...
              infrastructure with TAKATAK
            </h2>

            <p className="mt-4 max-w-3xl text-base leading-7 text-muted-foreground">
              Domains, hosting, websites,
              marketing, local visibility,
              lead generation,
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 lg:grid-cols-2">
          <Link
            href="/domain"
            className="group overflow-hidden rounded-3xl border border-border bg-card p-5 shadow-[var(--shadow-card)] transition-all hover:-translate-y-0.5 hover:border-primary/45"
          >
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-[minmax(0,1fr)_220px] sm:items-center">
              <div>
                ...
                <h3 className="mt-3 text-2xl font-bold text-foreground">
                  Secure the name your
                  customers remember
                </h3>

                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Search, request, and
                  prepare domains for DNS,
                  email, websites, and
                  hosting inside the
                  TAKATAK flow.
                </p>
          ...
          >
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-[minmax(0,1fr)_220px] sm:items-center">
              <div>
                ...
                <h3 className="mt-3 text-2xl font-bold text-foreground">
                  Hosting built for launch,
                  email, and growth
                </h3>

                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  WordPress-ready plans with
                  SSL, email, cPanel,
                  backups, and
                  ...
                  <div className="mt-4 grid grid-cols-3 gap-2">
                    {[62, 78, 46].map(
                      (height) => (
                        <div
                          key={height}
                          className="rounded-md bg-primary/15"
                          style={{
                            height: `${height}px`,
                          }}
                        />
        ...
        <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Link
            ...
            className="rounded-2xl border border-border bg-card p-5 shadow-[var(--shadow-card)] transition-colors hover:border-primary/40 lg:col-span-2"
          >
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">
              Website Creation
            </p>
            ...
            <h3 className="mt-3 text-xl font-bold text-foreground">
              Custom sites that connect
              brand, offer, content, and
              conversion
            </h3>

            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              TAKATAK structures the brief,
              design, pages, launch path,
              and delivery workspace.
            </p>
          ...
          >
            ...
            <h3 className="mt-3 text-xl font-bold text-foreground">
              Vetted execution for logos,
              content, tech, data, and
              growth work
            </h3>

            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              Browse fixed packages or
              post a custom project with
              TAKATAK-managed approvals.
            </p>
            ...
            (service) => {
              ...
              return (
                <Link
                  key={service.title}
                  href={service.href}
                  className="group rounded-2xl border border-border bg-card p-5 shadow-[var(--shadow-card)] transition-colors hover:border-primary/40"
                >
